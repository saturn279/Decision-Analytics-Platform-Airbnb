...
def show_predict_page(city,df,model_seattle_revenue,model_seattle_booking_rate,describe):
    ...
    safe_html="""  
      <div style="background-color:#EEF1FF;padding:10px >
        <h2 style="text-align: center;color:black;"> {} is in the top {} percentile </h2>
        </div>
    """
    danger_html="""  
      <div style="background-color:#F08080;padding:10px >
        <h2 style="'color':black ;'text-align' : center;"> {} is in the bottom {} percentile</h2>
        </div>
    """
    medium_html="""  
      <div style="background-color:#F1E36B;padding:10px >
        <h2 style="'color':black ;'text-align' : center;"> {} is in the top {} percentile </h2>
        </div>
    """
    ...
    #     st.markdown(medium_html.format('revenue','75'),unsafe_allow_html=True)
    # else:
    #     st.markdown(safe_html.format('revenue','25'),unsafe_allow_html=True)
    st.text('                                        ') 
    output2=model_seattle_booking_rate.predict(input)
